...
from pydantic import BaseModel, Field, PrivateAttr     # pydantic : 사실상의 표준
import requests
import os
...
# FlightSearchTool
class FlightSearchInput(BaseModel):          # input argument
...
class FlightSearchTool(BaseTool):
    ...
    def get_city_code(self, city_name):     # 도시 이름을 IATA 코드로 변환
        city_codes = {
...
class NearbyPlacesTool(BaseTool):
    ...
    def get_place_details(self, place_id):
        ...
        return {
            ...
            } for review in result.get("reviews", [])[:3]]  # 최근으로 최대 3개 리뷰
        }
